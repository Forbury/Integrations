...
using Forbury.Integrations.API.v1.Dto.Model.Input.Space.Lease;
using Forbury.Integrations.API.v1.Dto.Model.Input.Space.Market;
using Forbury.Integrations.API.v1.Dto.Model.Input.Space.Renewal;
using Newtonsoft.Json;
using Newtonsoft.Json.Converters;

namespace Forbury.Integrations.API.v1.Dto.Model.Input.Space
{

...
using Forbury.Integrations.API.v1.Dto.Input.Space.Lease;
using Forbury.Integrations.API.v1.Dto.Input.Space.Market;
using Forbury.Integrations.API.v1.Dto.Input.Space.Renewal;
using Newtonsoft.Json;
using Newtonsoft.Json.Converters;

namespace Forbury.Integrations.API.v1.Dto.Input.Space
{
